...
update_car_pos proc
    ...
    int 16h
    jz end_car
    mov ah, 10h ; retrieve key from buffer
    int 16h
    cmp al, 27 ; ESC
    je _exit_func
    cmp al, 119 ; W
...
increase_difficulty proc
     ...
     jb _exit_increase_difficulty
         ...
         sub al,bl  
         mov byte ptr[time_interval], al
     _exit_increase_difficulty:
     popa
     ret
increase_difficulty endp 
